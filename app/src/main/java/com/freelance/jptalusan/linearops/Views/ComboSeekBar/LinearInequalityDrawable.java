 ...
 * @author sazonov-adm
 */
public class LinearInequalityDrawable extends Drawable {
    ...
    public final void draw(Canvas canvas) {
        ...
        ComboSeekBar.Dot selected = null;
        ...
        canvas.drawLine(mDots.get(0).mX, middleY, selected.mX, middleY, redPaint);
        canvas.drawLine(selected.mX, middleY, mDots.get(size).mX, middleY, greenPaint);
